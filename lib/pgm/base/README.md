...
Package `base` provides the foundational graph types used by all datascience models.

**Import path:** `github.com/asymmetric-effort/datascience/lib/pgm/base`
...
```go
import "github.com/asymmetric-effort/datascience/lib/pgm/base"
